...
df1a = df1 %>% group_by(month) %>% summarise(avg=mean(number_of_employees_that_left)) %>%
  mutate(s="Pixel Systems - Outdated work practices but low efforts to improve work culture",s2 ="Scenario 1")

df2a = df2 %>% group_by(month) %>% summarise(avg=mean(number_of_employees_that_left)) %>% mutate(s="Woodcoms - Outdated work practices and no efforts to improve", s2 ="Scenario 2")

df3a = df3 %>% group_by(month) %>% summarise(avg=mean(number_of_employees_that_left)) %>% mutate(s="Sun Co. - Outdated work practices but moderate efforts to improve work culture",s2 ="Scenario 3")

df = rbind(df1a, df2a, df3a) %>%
  group_by(s) %>%
  mutate(cs = cumsum(avg)) %>%
  mutate(s = factor(s, levels=c("Pixel Systems - Outdated work practices but low efforts to improve work culture","Woodcoms - Outdated work practices and no efforts to improve","Sun Co. - Outdated work practices but moderate efforts to improve work culture")))
...
### 1b: Line plot
df1b = df1 %>% mutate(s="Pixel Systems - Outdated work practices but low efforts to improve work culture", s2 ="Scenario 1")

df2b = df2 %>% mutate(s="Woodcoms - Outdated work practices and no efforts to improve", s2 ="Scenario 2")

df3b = df3 %>% mutate(s="Sun Co. - Outdated work practices but moderate efforts to improve work culture", s2 ="Scenario 3")
...
df1c = df1 %>% group_by(month) %>% summarise(avg=mean(number_of_employees_that_left)) %>%
  mutate(s="**Pixel Systems**<br><span style = 'font-size:10pt'>Outdated work practices but low<br>efforts to improve work culture</span>",s2 ="Scenario 1")

df2c = df2 %>% group_by(month) %>% summarise(avg=mean(number_of_employees_that_left)) %>% mutate(s="**Woodcoms**<br><span style = 'font-size:10pt'>Outdated work practices<br>and no efforts to improve</span>", s2 ="Scenario 2")

df3c = df3 %>% group_by(month) %>% summarise(avg=mean(number_of_employees_that_left)) %>% mutate(s="**Sun Co.**<br><span style = 'font-size:10pt'>Outdated work practices but<br>moderate efforts to improve</span>",s2 ="Scenario 2")

dfc = rbind(df1c, df2c, df3c) %>%
  mutate(s=factor(s, levels=c("**Pixel Systems**<br><span style = 'font-size:10pt'>Outdated work practices but low<br>efforts to improve work culture</span>","**Woodcoms**<br><span style = 'font-size:10pt'>Outdated work practices<br>and no efforts to improve</span>","**Sun Co.**<br><span style = 'font-size:10pt'>Outdated work practices but<br>moderate efforts to improve</span>")))
...
## Section 2: Turnover
t1 = read_csv("20220420-results/scenario_01_turnover.csv") %>% janitor::clean_names() %>% mutate(s="Pixel Systems - Outdated work practices but low efforts to improve work culture")

t2 = read_csv("20220420-results/scenario_02_turnover.csv") %>% janitor::clean_names() %>% mutate(s="Woodcoms - Outdated work practices and no efforts to improve")

t3 = read_csv("20220420-results/scenario_03_turnover.csv") %>% janitor::clean_names() %>% mutate(s="Sun Co. - Outdated work practices but moderate efforts to improve work culture")
