...
Source: [U.S. Bureau of Labor Statistics](https://data.bls.gov/pdq/SurveyOutputServlet)
...
p1 = df %>% pivot_longer(!Year) %>%
  ...
  theme(text=element_text(family=f1),
        ...
        plot.caption = element_text(color = "grey40", hjust = .5, size=rel(.9), margin = margin(t = -25, b = -30)),
        ) +
  ...
  labs(title="**Consumer Price Index**:<br>1-Month Percent Change<br>",
       ...
       caption="Source: U.S. Bureau of Labor Statistics | Plot inspired by Spencer Schien @MrPecners") +
